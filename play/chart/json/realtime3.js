...
Vue.createApp({
    ...
    mounted() {
        ...
        // updateWidget()/render() calls. Array mutations (shift/push) run on `this.axis[0].data`
        // (the reactive proxy) directly - see realtime2.js's comment for why mutating a plain array
        // that merely shares the initial reference would silently never re-render.
